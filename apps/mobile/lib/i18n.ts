...
const en = {
  ...
  "settings.capabilities.voice.get": "Get (75MB)",
  "settings.capabilities.voice.delete.title": "Remove Voice Engine",
  "settings.capabilities.voice.delete.msg": "Are you sure you want to delete the offline dictation engine? You will need to download the ~75MB file again to use dictation.",
  "settings.capabilities.voice.delete.confirm": "Remove",
  "settings.capabilities.voice.req.title": "Voice Engine Required",
  "settings.capabilities.voice.req.msg": "To use incredibly fast, 100% offline dictation, Omnia needs to download the 75MB Whisper AI Engine.",
...
const pt: typeof en = {
  ...
  "settings.capabilities.voice.get": "Baixar (75MB)",
  "settings.capabilities.voice.delete.title": "Remover Motor de Voz",
  "settings.capabilities.voice.delete.msg": "Tem certeza de que deseja apagar o motor de ditado offline? Você precisará baixar o arquivo de ~75MB novamente para usar o ditado.",
  "settings.capabilities.voice.delete.confirm": "Remover",
  "settings.capabilities.voice.req.title": "Motor de Voz Necessário",
  "settings.capabilities.voice.req.msg": "Para usar o ditado 100% offline e incrivelmente rápido, o Omnia precisa baixar o Motor de IA Whisper de 75MB.",
...
const es: typeof en = {
  ...
  "settings.capabilities.voice.get": "Bajar (75MB)",
  "settings.capabilities.voice.delete.title": "Quitar Motor de Voz",
  "settings.capabilities.voice.delete.msg": "¿Estás seguro de que quieres eliminar el motor de dictado offline? Necesitarás descargar el archivo de ~75MB nuevamente para usar el dictado.",
  "settings.capabilities.voice.delete.confirm": "Quitar",
  "settings.capabilities.voice.req.title": "Motor de Voz Requerido",
  "settings.capabilities.voice.req.msg": "Para usar el dictado increíblemente rápido y 100% offline, Omnia necesita descargar el Motor de IA Whisper de 75MB.",
