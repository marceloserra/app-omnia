...
Objective:
Resolve unit testing setup conflicts in `apps/mobile` for React 19 (Milestone 2). This is a replacement for a previous worker that hung.
...
3. Update `apps/mobile/jest.config.js` to ensure the `transformIgnorePatterns` lookahead regex allows `react-native-reanimated`, `@gorhom/bottom-sheet`, and other ESM modules inside node_modules to be transpiled. E.g.:
...
/Users/marceloserra/Documents/coding/projects/app-omnia/.agents/teamwork_preview_worker_m2_2/handoff.md
